...
"""autogenerated by genpy from kuka_node/ExecuteTrajectoryAction.msg. Do not edit."""
import sys
...
import kuka_node.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class ExecuteTrajectoryAction(genpy.Message):
  _md5sum = "ec955d1742cfc8e7a1d83f1759573dc9"
  _type = "kuka_node/ExecuteTrajectoryAction"
...
float32 data"""
  ...
  _slot_types = ['kuka_node/ExecuteTrajectoryActionGoal','kuka_node/ExecuteTrajectoryActionResult','kuka_node/ExecuteTrajectoryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = kuka_node.msg.ExecuteTrajectoryActionGoal()
      if self.action_result is None:
        self.action_result = kuka_node.msg.ExecuteTrajectoryActionResult()
      if self.action_feedback is None:
        self.action_feedback = kuka_node.msg.ExecuteTrajectoryActionFeedback()
    else:
      self.action_goal = kuka_node.msg.ExecuteTrajectoryActionGoal()
      self.action_result = kuka_node.msg.ExecuteTrajectoryActionResult()
      self.action_feedback = kuka_node.msg.ExecuteTrajectoryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_result.result.error.data, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.action_feedback.feedback.percentage.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.error.data, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      self.action_result.result.error.data = bool(self.action_result.result.error.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.percentage.data,) = _struct_f.unpack(str[start:end])
      return self
